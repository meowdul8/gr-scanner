 ...
 */
static inline void dump_cw(const voice_codeword& cw, int len, FILE* fp) // len in bytes
{
   int i, j;
   for(i = 0; i < len; i++)
   {
...
static inline void imbe_store_bits(voice_codeword& cw, int s, int l, uint32_t v)
{
   for(int i = l - 1; i >= s; i--)
   {
      cw[i] = v & 1;
...
static inline uint32_t pngen15(uint32_t& Pr)
{
   int n = 0;
   for(int i = 14; i >= 0; --i)
   {
...
static inline uint32_t pngen23(uint32_t& Pr)
{
   int n = 0;
   for(int i = 22; i >= 0; --i)
   {
...
static inline size_t imbe_header_decode(const voice_codeword& cw,
   uint32_t& u0,
   uint32_t& u1,
   uint32_t& u2,
   uint32_t& u3,
 ...
 */
static inline void imbe_pack(packed_codeword& cw,
   uint32_t u0,
   uint32_t u1,
   uint32_t u2,
   uint32_t u3,
...
static inline void imbe_header_encode(voice_codeword& cw,
   uint32_t u0,
   uint32_t u1,
   uint32_t u2,
   uint32_t u3,
...
static inline void imbe_deinterleave(
   const_bit_vector& frame_body, voice_codeword& cw, uint32_t frame_nr)
{
...
static inline void imbe_interleave(
   bit_vector& frame_body, const voice_codeword& cw, uint32_t frame_nr)
{
   for(size_t j = 0; j < voice_codeword_sz; ++j)
   {
...
static inline void imbe_frame_unpack(uint8_t* A,
   uint32_t& u0,
   uint32_t& u1,
   uint32_t& u2,
   uint32_t& u3,
 ...
 */
static inline void imbe_regenerate_frame(bit_vector& cw)
{
   unsigned int u0 = 0;
 ...
 */
static inline void imbe_regenerate_voice_unit(bit_vector& frame_body)
{
